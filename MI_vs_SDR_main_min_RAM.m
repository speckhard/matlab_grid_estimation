...
node_volt_matrix = csvread('/afs/ir.stanford.edu/users/d/t/dts/Documents/Rajagopal/Sandia Data/SG2_data_solar_1min.csv',...
   9,22, data_limits);
...
results = struct(field1, value1, field2, value2, field3, value3,...
    field4, value4);
% Save a .mat file.
save('/afs/ir.stanford.edu/users/d/t/dts/Documents/Rajagopal/Results/SG2-solar-1min-deriv_12_10_min_RAM_corn'...
     ,'results')
% save('results')