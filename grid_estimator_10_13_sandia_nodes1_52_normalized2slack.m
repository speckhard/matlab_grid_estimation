...
%% Normalize data relative to the slack

normalized_Sandia_data = zeros(size(SGdatanodevolt(:,1:52)));
for i = 1:number_of_buses
    normalized_Sandia_data(:,i) = SGdatanodevolt(:,i)...
    - SGdatanodevolt(:,53);
end
...
single_node_entropy_vec = find_single_node_entropy(normalized_Sandia_data);
...
joint_entropy_matrix = find_joint_entropy(normalized_Sandia_data);
