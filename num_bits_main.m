        ...
        for k = 1:num_of_lenses
            ...
            for l = 2:2% 1:num_MI_methods
                ...
                [sdr, estimated_branch_list, MI_mat, leaf_node_SDR, ...
                    ...
                    compute_sdr(node_volt_mat_lens,true_branch_data, ...
...
%% Save a .mat file.
save('/afs/ir.stanford.edu/users/d/t/dts/Documents/Rajagopal/Results/num_bits/SG2_deriv_num_bits_lens_1_29_JVHW_only_v1'...
    ,'results')
