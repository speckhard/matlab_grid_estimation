...
%    9,22, data_limits);
node_volt_matrix = csvread('/farmshare/user_data/dts/SG_data_solar_1min.csv',...
   9,22, data_limits);
...
%% Save a .mat file.
save('/afs/ir.stanford.edu/users/d/t/dts/Documents/Rajagopal/Results/SG2_solar_vary_deriv_12_31_v1'...
     ,'results')
