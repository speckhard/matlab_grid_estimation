...
%% Add Noise to Data
percent_noise_vec = 1/100*[10, 1, 0.1, 0.01, 0.001, 0.0001];
sdr_vec = zeros(numel(percent_noise_vec),1);
...
% bits_desired = 8;
% node_volt_matrix_digital = digitizer(node_volt_matrix_downsampled, ...
