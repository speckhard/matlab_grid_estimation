...
%     9,22,data_limits);
node_volt_matrix = csvread('/farmshare/user_data/dts/S2_data_volt_1min.csv',...
   9,22, data_limits);
...
% Save a .mat file.
save('/afs/ir.stanford.edu/users/d/t/dts/Documents/Rajagopal/Results/lens_res/SG2_deriv_lens_res_barley_010117_v1'...
     ,'results')
